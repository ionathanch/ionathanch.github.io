...
I obtained a second edition copy of [_Markup of Mathematical Formulas_](https://archive.org/details/markup-of-mathematical-formulas)
from the University of Victoria, which lists the same entities, also missing our character.

{% include image.html
           img="/assets/images/angzarr/MMF.png"
           width="75%"
           title="Additional Mathematical Symbols: Arrow Relations (ISO 8879-1986 Added Math Symbols: Arrow Relations)"
           caption="Excerpt from Markup of Mathematical Formulas, Appendix C Entity References for use in Mathematical Formulas" %}
...
(accessible as [CAN/CSA-ISO/IEC 10036-01 (R2014)](https://www.csagroup.org/store/product/CAN%25100CSA-ISO%25100IEC%2010036-01/))
only describes glyph registration, the actual [10036 registry](https://10036ra.org/glyph-index.html) exists online.
...
established in 1987 (according to [this search](https://icis.corp.delaware.gov/Ecorp/EntitySearch/NameSearch.aspx)).
...
ISO/IEC 10036 provides the registration process along with
contact information for the AFII in Annex A Registration Authority.

> Association for Font Information Interchange <br/>
Post Office Box 33683 <br/>
Northglenn, Colorado  80233-0683 <br/> <br/>
Telephone: +1 303 924-7670 <br/>
Facismile: +1 303 451-5475 <br/>
Email: afii@ix.netcom.com <br/>
...
> The information in the video is inaccurate.
It fails to recognize that the inclusion of the character in the STIX collection was based on its presence in a version of ISO 9573-13 earlier than the 1991 version cited,
a version which existed long before AFII was formed.
So any claim that it originated with AFII is chronologically invalid.
...
* 1983: [AAP Electronic Manuscript Project](https://en.wikipedia.org/wiki/AAP_DTD)
  begins, publishing a series that includes *Markup of Mathematical Formulas*
* 1986-10-15: [ISO 8879](https://www.iso.org/standard/16387.html) (SGML) is published,
  containing ISO AMS-A without ⍼, referencing *Markup of Mathematical Formulas*
* 1987-09-15: AFII is established
* 1987-11: [*Markup of Mathematical Formulas*](https://archive.org/details/markup-of-mathematical-formulas),
  2 ed. is published without ⍼, referencing ISO 8879
* 1988-12: [ISO/IEC TR 9573](https://www.iso.org/standard/17319.html)
...
* 1991-07-01: [ISO/IEC TR 9573-13](https://www.iso.org/standard/17332.html)
  (Public entity sets for mathematics and science) is published,
  containing ISO AMS-A with the first verifiable occurrence of ⍼,
  referencing ISO/IEC 10036
* 1993-06: [ISO/IEC 10036](https://www.iso.org/standard/17998.html) (Glyph registration) is published
* 1993: [*International Glyph Register*](http://www.worldcat.org/oclc/33864318) by the AFII is published,
  possibly containing ⍼
* 1994-09: [ISO 12083](https://www.iso.org/standard/20866.html)
  (Electronic manuscript preparation and markup) is published,
  based on ANSI/NISO Z39.59, with no entity tables
* 1996-07: [ISO/IEC 10036](https://www.iso.org/standard/24744.html) is revised,
  referencing the *International Glyph Register*
* 1997-06: The [STIX](https://www.ams.org/STIX/) project begins,
  taking character tables from ISO/IEC TR 9573-13
* 2000-03-14: [ISO/IEC JTC1/SC2/WG2 N2191](https://www.unicode.org/wg2/docs/n2191.pdf)
...
* [Hacker News](https://news.ycombinator.com/item?id=31012865), [Lobste.rs](https://lobste.rs/s/tmv8x7), and [Hackaday](https://hackaday.com/?p=532039) discussions
...
* [Half as Interesting](https://youtu.be/cCoed5Oo_J4) did a video on this post (don't bother, it's less than half as interesting)

{% include image.html
           img="/assets/images/angzarr/HAI.png"
           width="40%"
           title="Screenshot of Half as Interesting's video: two characters high-fiving, one whose head has been replaced by their logo and the other with a bag over their head, with the subtitle &quot;Good unpaid labour, Jonathan!&quot;."
           caption="Thanks I guess?? sldkghfhg 💀" %}